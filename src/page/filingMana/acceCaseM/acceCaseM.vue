  ...
  <div class="acceCase">
    <div class="_center pr">
      ...
      <Row>
        ...
        <Col span="8">
          <Input v-model="search.text" icon="ios-search" class="_search hand" @on-click="resSearch('pageNum1')" @keyup.enter.native="resSearch('pageNum1')" placeholder="申请人 / 被申请人"></Input>
        </Col>
        <Col span="8">
          &nbsp;
        </Col>
    ...
    <alert-btn-info :alertShow="alertShow.acceA" @alertConfirm="acceSave('acceA')" @alertCancel="alertCanc('acceA')" alertTitle="通过案件">
      <p>确定要通过吗？</p>
    </alert-btn-info>
