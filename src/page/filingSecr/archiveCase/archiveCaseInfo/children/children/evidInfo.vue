          ...
          <Col span="22" offset="1">
            ...
            <p>
              <Row>
                ...
                <Col span="20">
                  <div class="_file" v-for="(item, index) in infoData.fileObjects" :key="index" :title="'点击查看: '+item.fileName" @click="seeFile(item.filePath)">{{item.fileName.length > 50 ? item.fileName.substr(0, 50) + '...' : item.fileName}}</div>
                </Col>
              </Row>
            </p>
            <p>
