<template>
  <div class="pr _uploadApplBook">
    ...
    <Row class="_labelFor">
      <Col span="6" offset="1">
        <div class="_label"><span class="_b">*</span><b>文书类型：</b></div>
      </Col>
      <Col span="16" class="_radio">
        <RadioGroup v-model="resData.documentType">
    ...
    <Row>
      <Col span="22" offset="1">
        <Row class="_labelFor">
          <Col span="12" class="_label"><b class="_b">*</b><span v-text="childName"></span></Col>
...
export default {
  ...
  components: { spinComp },
  props: ['uploadUrl', 'fileType', 'childName', 'dowShow', 'docuType'],
  data () {
    return {
      spinShow: false,
      progressText: null,
